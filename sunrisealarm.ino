...
void setup() {
    ...
    Alarm.alarmRepeat(dowTuesday, 6,0,0, MorningAlarm);
    Alarm.alarmRepeat(dowWednesday, 6,0,0, MorningAlarm);
    Alarm.alarmRepeat(dowThursday, 6,0,0, MorningAlarm);
    Alarm.alarmRepeat(dowFriday, 6,0,0, MorningAlarm);
