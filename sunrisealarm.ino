...
String weekdayStatus = "<not set>";
String weekendStatus = "<not set>";
...
void setup() {
    ...
    Particle.variable("alarmEnabled", isAlarmEnabled);
    Particle.variable("wdStatus", weekdayStatus);
    Particle.variable("weStatus", weekendStatus);
